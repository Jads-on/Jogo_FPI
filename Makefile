...
SRC = src/camera.c src/colisoes.c src/creditos.c src/fase_1.c src/gameover.c src/gestor_fases.c src/historia.c src/inimigos.c src/jogador.c src/main.c src/menu.c src/spawn.c src/tiros.c     
